...
class FileOpener:
    def __init__(self, screen: pygame.surface.Surface,tilePalette: TilePalette,updateMainRect,notification):
        self.screen = screen
    ...
    def cancel_editing(self):
        ...
        self.nm.notify('info', 'Information', 'Édition annulée.',duration=1.5)
    ...
    def handleEvents(self):
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                self.nm.notify('info', 'Information', 'Operation Annulée.',duration=1.0)
                self.editing = False
                ...
                if self.pickingColor:
                    try:
                        ...
                        self.nm.notify('warning', 'Attention', 'Impossible de récupérer la couleur.',duration=1.0)
    ...
    def validate_tileMap(self):
        ...
        self.editing=False
        self.updateMainRect()
        self.nm.notify('success', 'Success', 'Tilemap ajoutée !.',duration=1.0)
